...
// Định nghĩa interface cho TooltipProps từ Recharts
...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const itemValue = item.payload?.[labelKey || 'value'];
      let value: React.ReactNode = label ?? itemConfig?.label ?? (itemValue !== undefined ? String(itemValue) : null);
